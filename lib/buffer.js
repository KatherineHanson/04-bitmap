...
buffer.loadIn = (data) => {
  ...
  // transforms.whiteout(this.buffer);
  // transforms.blackout(this.buffer);
  // transforms.invert(this.buffer);
  // transforms.noise(this.buffer);
  return this;
};
...
//   this.numImportantColors = data.readUInt32LE(50);
  ...
  //   return;
  // }
//   let newTransform = new transforms(data);
//   callback(null, newTransform);
// };
